...
A car fleet management (starter) system built with AWS services, featuring event-driven architecture with Kafka and microservices for telemetry processing.
