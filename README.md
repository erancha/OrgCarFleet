...
- **Cognito User Pool**: Google OAuth authentication
- **API Gateway**: HTTP API with Cognito authorizer
- **Lambda**: Ingestion and batch producer functions
- **SQS**: Event buffering and decoupling

### External Services (AWS EC2)

- **Kafka Cluster**: `ec2-3-71-113-150.eu-central-1.compute.amazonaws.com:19092`
- **PostgreSQL/PostGIS**: `ec2-63-180-181-179.eu-central-1.compute.amazonaws.com:5432`
